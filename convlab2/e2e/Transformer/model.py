...
import json
from convlab2.e2e.Transformer.train import SPECIAL_TOKENS_V1, SPECIAL_TOKENS_V4,\
    build_input_from_segments_v1, act_name, slot_name
from convlab2.util.multiwoz.dbquery import Database
from convlab2.e2e.Transformer.pytorch_transformers import GPT2DoubleHeadsModel, GPT2Tokenizer
from convlab2.e2e.Transformer.util import download_model_from_googledrive
...
class Transformer(Agent):
        ...
        while i < self.max_length:
            ...
            if prev.item() in dptok:
                ...
                if cs_count == 0:
                    ...
                    kb_results = self.database.query(self.cur_dom, constraints) if self.cur_dom else None
    ...
    def response(self, usr):
        ...
        print('current domain : ', self.cur_dom)
        print('dialogue state :', cs_dict)
        print('system action :', self.decode(dialog_act))
        print('kb :', kb_results)
